...
const ConnectButton: FC = () => {
  ...
  return (
    <div className="rounded-lg border-[0.75px] border-primary-300 bg-primary-200 shadow-btn-inner text-primary-100 tracking-[0.32px] py-2 px-2 w-[140px] lg:w-[180px] group relative">
      {publicKey ? (
        <>
